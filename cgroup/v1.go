...
func (c *cgroupv1) SetLogger(logger *log.Logger) {
	c.log = logger
}

// GetDeviceCGroupMountPath returns the mount path (and its prefix) for the device cgroup controller associated with pid
func (c *cgroupv1) DeviceCGroupMountPath(procRootPath string, pid int) (string, string, error) {
...
func (c *cgroupv1) DeviceCGroupRootPath(procRootPath string, prefix string, pid int) (string, error) {
